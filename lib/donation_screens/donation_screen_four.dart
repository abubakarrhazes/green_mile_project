...
class DonationScreenFour extends StatefulWidget {
  const DonationScreenFour({super.key});

  @override
  State<DonationScreenFour> createState() => _DonationScreenFourState();
}

class _DonationScreenFourState extends State<DonationScreenFour> {
      ...
      body:SingleChildScrollView(
        child:SafeArea(
          child: Padding(
            ...
            Row(
              children:[
                Image.asset('assets/images/ngo1.png',
                height:100,
                width: 170,
                ),
                ...
                Column(
                  ...
                  children: <Widget>[
                    Container(
                      width:120,
                      child: const Text('Nigeria network of NGO\'s',
                      style:TextStyle(
                        color:Colors.white,
                        fontSize:20,
               ...
               Column(
                ...
                Text('About',
                  style:TextStyle(
                   ...
                   SizedBox(height:12),
                Text
                ('Nigeria network of NGO\'s is a non-governmental organisation formed in west africa with the aim to help young ladies who are being  victims rape abuses,environmental violence,human right abuse and so on.They are responsible for hiring lawyers to fight any case of indiscrimination.',
                  style:TextStyle(
                   fontSize:13,
                   color: Colors.grey,
                   fontWeight:FontWeight.bold
