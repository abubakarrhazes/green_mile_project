...
class DonationScreenFive extends StatefulWidget {
  const DonationScreenFive({super.key});

  @override
  State<DonationScreenFive> createState() => _DonationScreenFiveState();
}

class _DonationScreenFiveState extends State<DonationScreenFive> {
      ...
      body:SingleChildScrollView(
        child:SafeArea(
          child: Padding(
            ...
            Row(
              children:[
                Image.asset('assets/images/prison3.jpg',
                height:100,
                width: 170,
                ),
                ...
                Column(
                  ...
                  children: <Widget>[
                    Container(
                      width:120,
                      child: const Text('Kirikiri Maximum Security Prison',
                      style:TextStyle(
                        color:Colors.white,
                        fontSize:20,
               ...
               Column(
                ...
                Text('About',
                  style:TextStyle(
                   ...
                   SizedBox(height:12),
                Text
                ('Kirikiri Maximum Security Prison is a non-governmental organisation formed in west africa with the aim to help young ladies who are being  victims rape abuses,environmental violence,human right abuse and so on.They are responsible for hiring lawyers to fight any case of indiscrimination.',
                  style:TextStyle(
                   fontSize:13,
                   color: Colors.grey,
                   fontWeight:FontWeight.bold
