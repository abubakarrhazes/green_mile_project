                            ...
                            child: Container(         
                              padding: const EdgeInsets.only(
                                   ...
                                   decoration: BoxDecoration(
                                          ...
                                          image:NetworkImage(imges[index]),    //AssetImage('assets/images/'+images.keys.elementAt()),
                                          fit:BoxFit.cover,
                    ...
                    SingleChildScrollView(
                      child: Container(
                        ...
                        InkWell(
                          ...
                          onTap: (){
                             Navigator.pushNamed(context, '/lawyerone');
                          },
                          child: Padding(
                            padding: const EdgeInsets.only(
                              left: 10,
                        ...
                        const SizedBox(height:20), //40
                         InkWell(
                          splashColor: Colors.grey,
                          onTap: (){
                             Navigator.pushNamed(context, '/lawyertwo');
                          },
                           child: Padding(
                            padding: const EdgeInsets.only(
                              left: 10,
                         ...
                         InkWell(
                          splashColor: Colors.grey,
                          onTap: (){
                             Navigator.pushNamed(context, '/lawyerthree');
                          },
                           child: Padding(
                            padding: const EdgeInsets.only(
                              left: 10,
                     ...
                     Expanded(
                       child: ListView(
                         ...
                         children:<Widget>[
                           ListTile(
                             onTap:(){
                                Navigator.pushNamed(context,'/donationone');
                             },
                             ...
                             title: const Padding(
                               ...
                               child:Text('Chikurubi Maximum Prison',
                               style: TextStyle(
                                 fontSize: 15,
                                 fontWeight: FontWeight.bold,
                               ),
                           ...
                           ListTile(
                             onTap:(){
                                 Navigator.pushNamed(context,'/donationtwo');
                             },
                             trailing: const Icon(Icons.more_vert),
                             ...
                             title: const Padding(
                               ...
                               child: Text('Voice for african development initiative',
                               style: TextStyle(
                                 fontSize: 15,
                                 fontWeight: FontWeight.bold,
                               ),
                             ...
                             subtitle: const Text('South Africa',
                               style: TextStyle(
                               fontSize: 13,
                               fontWeight: FontWeight.bold,
                               color: Colors.grey
                           ...
                           ListTile(
                             onTap:(){
                                Navigator.pushNamed(context,'/donationthree');
                             },
                             trailing: const Icon(Icons.more_vert),
                             ...
                             title: const Padding(
                               ...
                               child: Text('The Mukobeko Maximum Prison',
                               style: TextStyle(
                                 fontSize: 15,
                                 fontWeight: FontWeight.bold,
                               ),
                           ...
                           ListTile(
                            onTap: (){
                                Navigator.pushNamed(context,  '/ donationfour');
                            },
                             trailing: const Icon(Icons.more_vert),
                             ...
                             title: const Padding(
                               ...
                               child: Text('Nigeria network of NGO\'s',
                               style: TextStyle(
                                 fontSize: 15,
                                 fontWeight: FontWeight.bold,
                               ),
                           ...
                           ListTile(
                             onTap: (){
                                 Navigator.pushNamed(context, '/donationfive');
                             } ,
                             trailing: const Icon(Icons.more_vert),
                             ...
                             title: const Padding(
                               ...
                               child: Text('Kirikiri Maximum Security Prison',
                               style: TextStyle(
                                 fontSize: 15,
                                 fontWeight: FontWeight.bold,
                               ),
                             ...
                             subtitle: const Text('Nigeria',
                              ...
                              const SizedBox(height:10),
                             const  ListTile(
                                title: Text('Do you own an organisation for rendering help?',
                                style: TextStyle(
                                  fontSize: 15,
                                  fontWeight: FontWeight.bold,
                                  color:Colors.grey,
                  ...
                  Container(
                    ...
                    itemCount: 4,
                      ...
                      decoration: BoxDecoration(
                          ...
                          color: Colors.white,
                           image:  DecorationImage(
                            image:NetworkImage(imgs[index]), //AssetImage('assets/images/'+images.keys.elementAt()),
                            fit:BoxFit.cover
                          ) 
                      ),
                              )
