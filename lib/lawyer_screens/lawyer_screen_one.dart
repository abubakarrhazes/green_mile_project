...
class LawyerScreenOne extends StatelessWidget {
   LawyerScreenOne({super.key});
                         ...
                         const  SizedBox(height:5),
                          ...
                          const  SizedBox(height:10),
                           Wrap(
                              ...
                              const  SizedBox(height:5),
                              const Text(
                              'Barrister Esther jones in known for her competence in bringing and implementing justice where duly served and she is proven to help you win to win any court case that is impossible to win',
                              style:TextStyle(
                                color:Colors.grey,
                                fontSize: 13,
                              )
