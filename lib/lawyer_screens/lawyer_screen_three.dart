...
class LawyerScreenThree extends StatelessWidget {
   LawyerScreenThree({super.key});
                         ...
                         const  SizedBox(height:5),
                          ...
                          const  SizedBox(height:10),
                           Wrap(
                              ...
                              const  SizedBox(height:5),
                              const Text(
                              'Barrister malcom omon in known for his competence in bringing and implementing justice where duly served.and he is proven to help you win to win any court case that is impossible to win',
                              style:TextStyle(
                                color:Colors.grey,
                                fontSize: 13,
                              )
